...
# renovate: datasource=docker depName=kairos/packages
ARG SUC_UPGRADE_VERSION=suc-upgrade-system-0.2.3
# renovate: datasource=docker depName=kairos/packages
ARG GRUB_CONFIG_VERSION=grub-config-static-0.11
# renovate: datasource=docker depName=kairos/packages
ARG OVERLAY_FILES_VERSION=kairos-overlay-files-static-1.1.58
# renovate: datasource=docker depName=kairos/packages
